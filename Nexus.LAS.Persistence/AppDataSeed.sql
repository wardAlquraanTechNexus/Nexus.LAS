...
INSERT [dbo].[Menus] ([id], [ParentID], [Name], [Path], [Rank], [Description], [IconClass], [InDashboard], [CreatedBy], [CreatedAt], [ModifiedBy], [ModifiedAt], [IsDeleted], [DeletedBy], [DeletedAt]) VALUES (5, 6, N'All Persons', N'Persons/All-Persons', 1, NULL, N'persons', 1, N'ward', CAST(N'2025-11-10T00:00:00.0000000' AS DateTime2), NULL, NULL, 0, NULL, NULL)
...
INSERT [dbo].[GroupsMenus] ([GroupID], [MenuID], [Access], [CanInsert], [CanUpdate], [CanDelete], [Admin], [id], [CreatedBy], [CreatedAt], [ModifiedBy], [ModifiedAt], [IsDeleted], [DeletedBy], [DeletedAt]) VALUES (1, 9, 1, 0, 0, 0, 1, 10, N'ward', CAST(N'2025-11-10T00:00:00.0000000' AS DateTime2), NULL, NULL, 0, NULL, NULL)
